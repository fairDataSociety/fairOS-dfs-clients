...
// APIClient manages communication with the FairOS-dfs server API vv0.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DirApi = (*DirApiService)(&c.common)
	c.DocApi = (*DocApiService)(&c.common)
